...
SENSORS: Dict[str, Dict[str, object]] = {
    ...
    "pv_current_a": sensor("PV Panel Status - Calculated PV Current", unit="A", device_class="current", state_class="measurement", icon="mdi:current-dc"),
    "pv_w": sensor("PV Panel Status - PV Power", unit="W", device_class="power", state_class="measurement", icon="mdi:solar-power"),
    "pv_surplus_w": sensor("PV Panel Status - PV Surplus Power", unit="W", device_class="power", state_class="measurement", icon="mdi:solar-power-variant"),
    "pv_generating": sensor("PV Panel Status - Generating", platform="binary_sensor", icon="mdi:solar-power"),
